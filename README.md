...
If expand file tree, you can see "main" branch which is also created.
It is important to know that every repository you create will have a single main branch at the start.
